"""Diffusers Style Attention Interface.

Supports pluggable attention processors. Based on the code from:
...
from xdiffusion.layers.norm import FP32LayerNorm, RMSNorm, SpatialNorm
