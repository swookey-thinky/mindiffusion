"""EDM layers and modules.

Model architectures and preconditioning schemes used in the paper
"Elucidating the Design Space of Diffusion-Based Generative Models".

Based on the code from: https://github.com/NVlabs/edm/blob/main/training/networks.py
"""
...
class UNetBlock(torch.nn.Module):
    ...
    Includes optional up/downsampling and self-attention.
    Represents the union of all features employed by the
    DDPM++ (https://arxiv.org/abs/2011.13456),
    NCSN++ (https://arxiv.org/abs/2011.13456), and
    ADM (https://arxiv.org/abs/2105.05233) architectures.
    """
