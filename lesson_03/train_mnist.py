...
from diffusion_model import GaussianDiffusion_NCSN
...
def run_lesson_3(num_training_steps: int, batch_size: int):
    ...
    diffusion_model = GaussianDiffusion_NCSN()
        ...
        while step < num_training_steps:
            ...
            if step != 0 and step % save_and_sample_every_n == 0:
                ...
                torch.save(
                    ...
                    f"{OUTPUT_NAME}/gaussian_diffusion_ncsn-{step}.pt",
                )
...
def main(override=None):
    ...
    run_lesson_3(num_training_steps=args.num_training_steps, batch_size=args.batch_size)
