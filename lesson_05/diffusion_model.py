...
class GaussianDiffusion_DDPM(torch.nn.Module):
    ...
    Defines the core DDPM diffusion algorithm for training and sampling.
    This implements Algorithms 1 and 2 from the DDPM paper.
    """
    ...
    def algorithm1_train_on_batch(self, image):
        """
        ...
        epsilon_theta = self._unet(
            sqrt_alphas_cumprod_x0 + sqrt_1_minus_alphas_cumprod_eps, t
        )
    ...
    def algorithm2_sampling(
        self, image_size: int, num_channels: int, batch_size: int = 16
    ):
        ...
        for t in tqdm(
            ...
            epsilon_theta = self._unet(x_t, batched_times)
