...
class ConditionalMNistUNet(torch.nn.Module):
    ...
    This model add Cross Attention mechanism from Attention Is All You Need
    (https://arxiv.org/abs/1706.03762). Cross attention is used for class
    conditioning during the training and inference phases.
    """
