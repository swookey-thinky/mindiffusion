"""Lesson 5a - Denoising Diffusion Probabilistic Models - Dropout
...
from score_network import MNistUNetWithDropout

OUTPUT_NAME = "output"


def run_lesson_5a(num_training_steps: int, batch_size: int):
    ...
    diffusion_model = GaussianDiffusion_DDPM(unet_type=partial(MNistUNetWithDropout, dropout=0.1))
    ...
    with tqdm(initial=step, total=num_training_steps) as progress_bar:
        ...
        while step < num_training_steps:
            ...
            loss = diffusion_model.algorithm1_train_on_batch(data)
...
def main(override=None):
    ...
    run_lesson_5a(num_training_steps=args.num_training_steps, batch_size=args.batch_size)
